...
//setMonto sirve para modificarlo
    ...
    const [tipoMovimiento, setTipoMovimiento] =
        useState<TipoMovimiento>("gasto"); //gastovalor inicial, TipoMovimiento indica el tipo de dato que puede guardar ese estado
    ...
    const categoriasFiltradas = categorias.filter( //nueva lista con categorias filtradas x cond
    ...
    const nuevaTransaccion: Transaccion = { //crear nueva transaccion
            ...
            <View>
                ...
                <View>
                    ...
                    <View style={styles.contenedorCategoria}>
                        ...
                        <Text style={styles.textoCategoria}>{categoriaSeleccionada
